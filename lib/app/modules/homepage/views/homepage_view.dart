          ...
          itemBuilder: (context, index) {
            ...
            return MeetingCard(
              ...
              onDelete: (context, index) =>
                  DialogUtils.showDeleteDialog(context: context, index: index),
              onEdit: (context, meeting) => DialogUtils.showMinutesDialog(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color:
                      Color(0xFFFFB347).withOpacity(0.2), // Sunny orange shadow
                  blurRadius: 15,
                ...
                child: GetBuilder<ContainerController>(
                  builder: (controller) => TableCalendar(
                    ...
                    headerStyle: HeaderStyle(
                      ...
                      titleCentered: true,
                      leftChevronIcon:
                          Icon(Icons.chevron_left, color: Color(0xFF9B4DCA)),
                      rightChevronIcon:
                          Icon(Icons.chevron_right, color: Color(0xFF9B4DCA)),
                    ),
                    ...
                    onDaySelected: (selectedDay, focusedDay) {
                      ...
                      final count =
                          controller.getMeetingCountForDate(selectedDay);
                      if (count > 0) {
